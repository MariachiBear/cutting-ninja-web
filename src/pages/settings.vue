...
<template>
   <div id="wrapper">
      ...
      >
         ...
         >
            <div id="profile-image-settings" class="w-full lg:w-3/11 xl:w-2/7 h-full">
               <ProfilePictureSettings />
            </div>
            <div
               id="other-settings"
               class="flex flex-col lg:flex-row w-full lg:w-8/11 xl:w-6/7 h-full items-start gap-10"
            >
